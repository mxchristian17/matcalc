...
import { poligonalArea } from '../../Global/calcFunctions';
...
function PoligonalArea(props) {

    const [resultVal, setResultVal] = useState({area: 0, apotema: 0})
    ...
    const calcVal = (value, inUnit, outUnit) => {
        const { area, apotema } = poligonalArea(value, inUnit, outUnit)
        setResultVal({area: area, apotema: apotema})
    }
    ...
    return (
        <div className="row justify-content-center">
            <div className="col col-md-9 col-lg-6">
                <h2 className="my-4">Cálculo de área de sección poligonal</h2>
                ...
                <form>
                    ...
                    <div className="input-group my-3">
                        <span className="input-group-text">Apotema:</span>
                        <span className="form-control bg-white">{ Math.round(resultVal.apotema*precision)/precision }</span>
                        <select className="custom-select form-control bg-light" style={{maxWidth: "6em"}} value={ inputUnit } onChange={(e) => changeInputUnits(e.target.value, calcVal)}>
                            <option value="0.001">mm</option>
                            <option value="0.01">cm</option>
                            <option value="1">m</option>
                    ...
                    <div className="input-group my-3">
                        ...
                        <span className="form-control bg-white">{ Math.round(resultVal.area*precision)/precision }</span>
